...
namespace DTNL.LL.DAL.Migrations
{
    ...
    [Migration("20220708140246_veryhightraffic")]
    partial class veryhightraffic
    {
            ...
            modelBuilder.Entity("DTNL.LL.Models.LifxLight", b =>
                {
                    ...
                    b.Property<int>("EffectCooldownInMinutes")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(5);
                    ...
                    b.Property<int>("VeryHighTrafficAmount")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(0);

                    b.Property<double>("VeryHighTrafficCycleTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("float")
                        .HasDefaultValue(1.0);

                    b.Property<string>("VeryHighTrafficFirstColor")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("VeryHighTrafficSecondColor")
                        .HasColumnType("nvarchar(max)");
